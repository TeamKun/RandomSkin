...
public class RandomManager {
    ...
    public void clearAll(){
        Set<String> s = NickNamerAPI.getNickedPlayerNames();
        for(String str : s){
            NickNamerAPI.getNickManager().removeNick(Bukkit.getOfflinePlayer(str).getUniqueId());
            NickNamerAPI.getNickManager().removeSkin(Bukkit.getOfflinePlayer(str).getUniqueId());
        }
    }
